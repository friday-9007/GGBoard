...
### 2.1 — Admin Auth
- [ ] Create Admin login API endpoint (`POST /auth/admin/login`)
- [ ] Password hashing (bcrypt or equivalent)
- [ ] JWT or session token generation on login
- [ ] Protect all admin routes with auth middleware
- [ ] Admin logout endpoint

### 2.2 — Team Leader Auth
- [ ] Create Team Leader login API endpoint (`POST /auth/leader/login`)
- [ ] Token generation on login
- [ ] Protect team leader routes with role-check middleware
- [ ] Team Leader logout endpoint

### 2.3 — General Auth Rules
- [ ] Role-based access control (RBAC) middleware
  - [ ] Admin → all routes
  - [ ] Team Leader → scoped routes only
  - [ ] Player / Public → read-only scoreboard only
- [ ] Token expiry and refresh logic (if needed)
- [ ] Handle unauthorized access with proper error responses
