...
1. Team Leader fills in:
   - Team Name
   - Team Leader Name & Credentials (username/password)
   - Select the active Game/Tournament to register under
2. System generates a **unique Team Code** (e.g., alphanumeric 6–8 character code)
3. Team Leader shares this code with their players for them to join
